...
class VNPay
{
     ...
     *
     */
    // static $vnp_TmnCode = "H9IOQMRX"; //Mã website tại VNPAY
    // static $vnp_HashSecret = "CXTKDIVPRMBVMXYUGKWBHHDQRKRTOICZ"; //Chuỗi bí mật
    ...
    public static function vnpay_create_payment(array $data)
    {
        ...
        $vnp_Returnurl = env('APP_URL') . '/checkout/vnPayCheck';
        $vnp_TmnCode = "H9IOQMRX"; //Mã website tại VNPAY 
        $vnp_HashSecret = "CXTKDIVPRMBVMXYUGKWBHHDQRKRTOICZ"; //Chuỗi bí mật
